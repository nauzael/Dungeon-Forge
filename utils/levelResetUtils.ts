...
export const compressCharacterToSnapshot = (character: Character): CharacterSnapshot => {
  return {
    ...
    savantSpellsAddedAt: character.savantSpellsAddedAt ? [...character.savantSpellsAddedAt] : undefined,
...
export const restoreCharacterFromSnapshot = (
  ...
  return {
    ...
    savantSpellsAddedAt: snapshot.savantSpellsAddedAt ? [...snapshot.savantSpellsAddedAt] : undefined,
