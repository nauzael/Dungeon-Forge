    ...
    return (
        <div className="flex flex-col h-full">
            ...
            >
                <button
                    onClick={handlePrev}
                    className="absolute left-1 z-10 w-10 h-10 rounded-xl bg-white dark:bg-[#1a2235] shadow-lg flex items-center justify-center text-slate-700 dark:text-white hover:bg-slate-50 dark:hover:bg-[#252d42] transition-colors border border-slate-200 dark:border-white/10"
                >
                    ...
                    <div className="bg-white dark:bg-[#1a2235] rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden shadow-xl">
                        ...
                        <div className="p-3 space-y-3 max-h-[35vh] overflow-y-auto no-scrollbar">
                            ...
                            <details className="border-t border-slate-100 dark:border-white/5 pt-2">
                                <summary className="text-[10px] font-bold text-slate-500 dark:text-slate-400 cursor-pointer hover:text-purple-500 transition-colors">
                ...
                <button
                    onClick={handleNext}
                    className="absolute right-1 z-10 w-10 h-10 rounded-xl bg-white dark:bg-[#1a2235] shadow-lg flex items-center justify-center text-slate-700 dark:text-white hover:bg-slate-50 dark:hover:bg-[#252d42] transition-colors border border-slate-200 dark:border-white/10"
                >
