...
const DeleteConfirmModal: React.FC<{
  ...
  return createPortal(
    ...
    >
      <div
        className="w-full max-w-sm bg-[#1b1f2b] rounded-3xl border border-red-500/20 shadow-2xl overflow-hidden animate-scaleIn"
        role="dialog"
      ...
      >
        ...
        <div className="p-4 flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 py-3.5 rounded-xl bg-slate-700/50 text-white font-bold text-sm hover:bg-slate-600/50 transition-colors active:scale-[0.98]"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 py-3.5 rounded-xl bg-red-500 text-white font-bold text-sm hover:bg-red-600 transition-colors active:scale-[0.98] shadow-lg shadow-red-500/30"
          >
            Delete
          </button>
        </div>
  ...
  return (
    <>
      ...
      <div
        ...
        role="button"
        tabIndex={0}
        className="group relative bg-[#1b1f2b] rounded-xl overflow-hidden iron-border transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#9adbff] focus:ring-offset-2 focus:ring-offset-[#090e19]"
      >
      ...
      >
        ...
        <main className="flex-1 pb-10 px-4 w-full mx-auto relative pt-8">
          ...
          >
            ...
            >
              <span className="material-symbols-outlined text-lg text-red-500/40 group-hover:text-red-500/80">
                logout
              </span>
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-red-500/40 group-hover:text-red-500/80">
                {t.logout}
              </span>
            </button>
          </div>
