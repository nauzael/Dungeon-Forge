            ...
            <div className="flex flex-col backdrop-blur-xl"
              style={{
                ...
                <div className="flex items-center gap-4 p-4">
                    <button onClick={onClose} className="w-10 h-10 flex items-center justify-center rounded-radius-pill transition-colors"
                      style={{
                    ...
                    <div className="flex-1 relative">
                        <input 
                            ...
                            autoFocus 
                            className="w-full rounded-radius-xl py-2.5 pl-11 pr-4 outline-none focus:ring-2 focus:ring-primary/50 transition-all font-medium"
                            style={{
                ...
                {filteredFeats.length > 0 ? filteredFeats.map(feat => {
                    ...
                    return (
                        <button 
                            ...
                            className={`w-full text-left p-5 rounded-radius-2xl border-2 transition-all duration-200 relative overflow-hidden group ${isSelected ? 'border-primary shadow-[0_0_20px_rgba(var(--color-primary),0.1)]' : 'border-slate-100 dark:border-white/5 hover:border-primary/30 hover:shadow-elev-modal'}`}
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2 relative z-10">
                                <div className="flex flex-wrap items-center gap-2">
                                    <span className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-radius-pill border ${getCategoryStyles(feat.category)}`}>
                                        {feat.category}
                                    </span>
                                    {feat.level > 1 && (
                                    <span className="text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-radius-pill" 
                                      style={{
                                        backgroundColor: 'var(--color-background-secondary)',
                                        borderColor: 'var(--color-border)',
                                        borderWidth: '1px',
