        ...
        return (
            <div key={title} className="flex flex-col gap-3 mb-6">
                <div className="flex items-center gap-2 px-1">
                    <div className="size-8 rounded-radius-md bg-primary/10 flex items-center justify-center text-primary"><span className="material-symbols-outlined text-lg">{icon}</span></div>
                ...
                <div className="space-y-2">
                    {items.map((feat, idx) => {
                        ...
                        return (
                            <div key={`${feat.name}-${idx}`} onClick={() => setSelectedFeature(feat)} className="rounded-radius-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/5 shadow-sm hover:border-primary/40 transition-all cursor-pointer group active:scale-[0.98]">
                                <div className="p-4 flex items-center justify-between gap-4">
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {feat.level > 1 && <span className="text-[10px] font-black text-primary bg-primary/10 px-1.5 py-0.5 rounded-radius-sm">Lvl {feat.level}</span>}
                                            {feat.name === 'Supreme Healing' && (
                                                <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/30 px-1.5 py-0.5 rounded-radius-sm flex items-center gap-1 cursor-help" title="When healing with dice, use the maximum value instead of rolling. E.g., 2d6 becomes 12 HP.">
    ...
    return (
        <div className="px-4 pb-24 pt-4 w-full">
            {isWarlock && (
                <div className="space-y-3 mb-8">
                    <div className="relative overflow-hidden group/warlock shadow-sm">
                        ...
                        <div className="relative flex flex-col gap-3 rounded-radius-2xl bg-surface-light dark:bg-surface-dark p-5 border border-fuchsia-500/30 backdrop-blur-md shadow-[0_4px_20px_-10px_rgba(217,70,239,0.3)]">
                            <div className="flex items-center gap-4">
                                <div className="size-12 rounded-radius-xl bg-fuchsia-500/10 dark:bg-fuchsia-500/20 flex items-center justify-center text-fuchsia-600 dark:text-fuchsia-400 shrink-0 border border-fuchsia-500/20">
                                ...
                                <button onClick={() => setShowInvocationTray(true)} className="px-4 py-2.5 rounded-radius-xl bg-fuchsia-600 hover:bg-fuchsia-500 text-white text-xs font-black uppercase tracking-widest shadow-elev-modal shadow-fuchsia-500/20 active:scale-95 transition-all whitespace-nowrap shrink-0">{isReadOnly ? 'View Tray' : 'Open Tray'}</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {isEldritchKnight && (
                <div className="space-y-3 mb-8">
                    <div className="relative overflow-hidden group/warbond shadow-sm">
                        ...
                        <div className="relative flex flex-col gap-3 rounded-radius-2xl bg-surface-light dark:bg-surface-dark p-5 border border-cyan-500/30 backdrop-blur-md shadow-[0_4px_20px_-10px_rgba(34,211,238,0.3)]">
                            <div className="flex items-center gap-4">
                                <div className="size-12 rounded-radius-xl bg-cyan-500/10 dark:bg-cyan-500/20 flex items-center justify-center text-cyan-600 dark:text-cyan-400 shrink-0 border border-cyan-500/20">
                                ...
                                <button onClick={() => { setTempBondedWeapons(character.bondedWeapons || []); setShowWarBondConfig(true); }} className="px-4 py-2.5 rounded-radius-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs font-black uppercase tracking-widest shadow-elev-modal shadow-cyan-500/20 active:scale-95 transition-all whitespace-nowrap shrink-0">{isReadOnly ? 'View' : 'Configure'}</button>
                            </div>
                            {character.summonedWeapon && (
                                <div className="flex items-center gap-2 px-3 py-2 rounded-radius-lg bg-cyan-500/10 border border-cyan-500/20">
                                    ...
                                    <button onClick={() => onUpdate({ ...character, summonedWeapon: null })} className="ml-auto px-2 py-1 rounded-radius-md bg-cyan-500/20 text-cyan-600 dark:text-cyan-400 text-[10px] font-bold uppercase">Dismiss</button>
                                </div>
                            )}
                        </div>
                    </div>
                    {character.level >= 7 && (
                        <div className="relative overflow-hidden group/warmagic shadow-sm">
                            ...
                            <div className="relative flex flex-col gap-3 rounded-radius-2xl bg-surface-light dark:bg-surface-dark p-5 border border-purple-500/30 backdrop-blur-md shadow-[0_4px_20px_-10px_rgba(168,85,247,0.3)]">
                                <div className="flex items-center gap-4">
                                    <div className="size-12 rounded-radius-xl bg-purple-500/10 dark:bg-purple-500/20 flex items-center justify-center text-purple-600 dark:text-purple-400 shrink-0 border border-purple-500/20">
                                    ...
                                    <button onClick={() => setShowWarMagicModal(true)} className="px-4 py-2.5 rounded-radius-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-black uppercase tracking-widest shadow-elev-modal shadow-purple-500/20 active:scale-95 transition-all whitespace-nowrap shrink-0">{isReadOnly ? 'View' : 'Configure'}</button>
                                </div>
                                {character.warMagicCantrip && (
                                    <div className="flex items-center gap-3">
                                        <button
                                            onClick={() => onUpdate({ ...character, warMagicActive: !character.warMagicActive })}
                                            className={`flex-1 py-3 rounded-radius-lg font-bold text-sm transition-all ${character.warMagicActive ? 'bg-purple-600 text-white shadow-elev-modal shadow-purple-500/30' : 'bg-slate-200 dark:bg-white/10 text-slate-600 dark:text-slate-400'}`}
                                        >
                    ...
                    {character.level >= 10 && (
                        <div className="relative overflow-hidden group/eldritch shadow-sm">
                            ...
                            <div className="relative flex flex-col gap-3 rounded-radius-2xl bg-surface-light dark:bg-surface-dark p-5 border border-amber-500/30 backdrop-blur-md shadow-[0_4px_20px_-10px_rgba(245,158,11,0.3)]">
                                <div className="flex items-center gap-4">
                                    <div className="size-12 rounded-radius-xl bg-amber-500/10 dark:bg-amber-500/20 flex items-center justify-center text-amber-600 dark:text-amber-400 shrink-0 border border-amber-500/20">
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2.5 rounded-radius-xl font-black text-xs uppercase tracking-widest shadow-elev-modal active:scale-95 transition-all ${character.eldritchStrikeActive ? 'bg-amber-500 text-white shadow-amber-500/30' : 'bg-slate-200 dark:bg-white/10 text-slate-600 dark:text-slate-400'}`}
                                    >
                                        {character.eldritchStrikeActive ? 'Active' : 'Inactive'}
                                    </button>
                                </div>
                                {character.eldritchStrikeActive && (
                                    <div className="flex items-center gap-2 px-3 py-2 rounded-radius-lg bg-amber-500/10 border border-amber-500/20">
                    ...
                    {character.level >= 15 && (
                        <div className="relative overflow-hidden group/arcane shadow-sm">
                            ...
                            <div className="relative flex flex-col gap-3 rounded-radius-2xl bg-surface-light dark:bg-surface-dark p-5 border border-indigo-500/30 backdrop-blur-md shadow-[0_4px_20px_-10px_rgba(99,102,241,0.3)]">
                                <div className="flex items-center gap-4">
                                    <div className="size-12 rounded-radius-xl bg-indigo-500/10 dark:bg-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 shrink-0 border border-indigo-500/20">
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2.5 rounded-radius-xl font-black text-xs uppercase tracking-widest shadow-elev-modal active:scale-95 transition-all ${character.arcaneChargeActive ? 'bg-indigo-500 text-white shadow-indigo-500/30' : 'bg-slate-200 dark:bg-white/10 text-slate-600 dark:text-slate-400'}`}
                                    >
                                        {character.arcaneChargeActive ? 'Active' : 'Inactive'}
                                    </button>
                                </div>
                                {character.arcaneChargeActive && (
                                    <div className="flex items-center gap-2 px-3 py-2 rounded-radius-lg bg-indigo-500/10 border border-indigo-500/20">
                    ...
                    {character.level >= 18 && (
                        <div className="relative overflow-hidden group/improved shadow-sm">
                            ...
                            <div className="relative flex flex-col gap-3 rounded-radius-2xl bg-surface-light dark:bg-surface-dark p-5 border border-rose-500/30 backdrop-blur-md shadow-[0_4px_20px_-10px_rgba(244,63,94,0.3)]">
                                <div className="flex items-center gap-4">
                                    <div className="size-12 rounded-radius-xl bg-rose-500/10 dark:bg-rose-500/20 flex items-center justify-center text-rose-600 dark:text-rose-400 shrink-0 border border-rose-500/20">
                                    ...
                                    <button onClick={() => setShowImprovedWarMagicModal(true)} className="px-4 py-2.5 rounded-radius-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-black uppercase tracking-widest shadow-elev-modal shadow-rose-500/20 active:scale-95 transition-all whitespace-nowrap shrink-0">{isReadOnly ? 'View' : 'Configure'}</button>
                                </div>
                                {character.improvedWarMagicActive && (
                                    <div className="flex items-center gap-2 px-3 py-2 rounded-radius-lg bg-rose-500/10 border border-rose-500/20">
            ...
            {selectedFeature && (() => {
                ...
                return createPortal(
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn" onClick={() => setSelectedFeature(null)}>
                        <div className="w-full max-w-sm bg-white dark:bg-surface-dark rounded-radius-2xl p-6 shadow-2xl flex flex-col max-h-[80vh] animate-scaleUp" onClick={e => e.stopPropagation()}>
                            <div className="flex justify-between items-start mb-5 border-b border-slate-100 dark:border-white/5 pb-4">
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        <span className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-primary bg-primary/10 px-2 py-0.5 rounded-radius-pill border border-primary/10">
                                            <span className="material-symbols-outlined text-[12px]">{ICON_MAP[selectedFeature.source]}</span>
                                            {selectedFeature.source}
                                        </span>
                                        {hasUsageTracking && (
                                            <div className="flex items-center gap-1.5 bg-amber-500/10 border border-amber-500/30 rounded-radius-pill px-3 py-1">
                                    ...
                                    {selectedFeature.name === 'Supreme Healing' && (
                                        <div className="mt-2 flex items-center gap-2 text-xs text-emerald-400 bg-emerald-500/10 border border-emerald-500/30 px-2 py-1 rounded-radius-md">
                                            <span className="material-symbols-outlined text-sm">auto_awesome</span>
                                            <span>All healing dice use maximum values</span>
                                        </div>
                                    )}
                                </div>
                                <button onClick={() => setSelectedFeature(null)} className="w-8 h-8 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-400"><span className="material-symbols-outlined">close</span></button>
                            </div>
                            ...
                            {hasUsageTracking && (
                                <div className="mt-6 pt-4 border-t border-slate-100 dark:border-white/10 space-y-3">
                                    <button
                                        ...
                                        className="w-full py-3.5 bg-red-500 hover:bg-red-600 disabled:bg-slate-200 disabled:text-slate-400 dark:disabled:bg-slate-700 dark:disabled:text-slate-500 text-white font-bold rounded-radius-lg flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
                                    >
                                    ...
                                    {featureUsageConfig.costToRestore && (
                                        <button
                                            ...
                                            disabled={isReadOnly}
                                            className="w-full py-3.5 bg-blue-500 hover:bg-blue-600 disabled:bg-slate-200 disabled:text-slate-400 dark:disabled:bg-slate-700 dark:disabled:text-slate-500 text-white font-bold rounded-radius-lg flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
                                        >
                            ...
                            <button onClick={() => setSelectedFeature(null)} className="w-full py-4 bg-primary text-background-dark font-bold rounded-radius-xl mt-4">Close</button>
                        </div>
                    </div>,
                    document.body
                );
            ...
            {showInvocationTray && createPortal(
                <div className="fixed inset-0 z-[60] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 bg-surface-light dark:bg-surface-dark border-b border-black/5 dark:border-white/10 flex items-center justify-between">
                        <button onClick={() => setShowInvocationTray(false)} className="size-10 rounded-radius-pill bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-500"><span className="material-symbols-outlined">close</span></button>
                        <h3 className="text-lg font-black uppercase tracking-widest text-fuchsia-500">Arcane Invocations</h3>
                        <div className="w-10"></div>
                    </div>
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-20">
                        <div className="bg-fuchsia-500/10 border border-fuchsia-500/20 rounded-radius-xl p-4 flex justify-between items-center">
                        ...
                        <div className="space-y-2">
                            {character.invocations?.map((invName) => {
                                ...
                                return (
                                    <div key={invName} className="bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/5 rounded-radius-xl p-4 shadow-sm">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {isTome && <button onClick={() => setShowTomeConfig(true)} className="flex items-center gap-1.5 px-3 py-1 rounded-radius-md bg-blue-500/10 text-blue-500 text-[10px] font-black uppercase border border-blue-500/20 active:scale-95 transition-all"><span className="material-symbols-outlined text-xs">auto_stories</span> Configure Tome</button>}
                                            {isAgonizing && <button onClick={() => setShowAgonizingConfig(true)} className="flex items-center gap-1.5 px-3 py-1 rounded-radius-md bg-amber-500/10 text-amber-500 text-[10px] font-black uppercase border border-amber-500/20 active:scale-95 transition-all"><span className="material-symbols-outlined text-xs">bolt</span> Configure Rays</button>}
                                            {isLessons && <button onClick={() => { setTargetLessonsInstance(invName); setShowLessonsConfig(true); }} className="flex items-center gap-1.5 px-3 py-1 rounded-radius-md bg-emerald-500/10 text-emerald-500 text-[10px] font-black uppercase border border-emerald-500/20 active:scale-95 transition-all"><span className="material-symbols-outlined text-xs">military_tech</span> Change Feat</button>}
                                        </div>
                                    </div>
                                );
                            })}
                    ...
                    <div className="fixed bottom-[env(safe-area-inset-bottom)] left-0 w-full p-4 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-t border-black/5 dark:border-white/5 flex gap-3">
                        <button onClick={() => setShowInvocationsModal(true)} disabled={currentInvocationsCount >= maxInvocations} className={`flex-1 py-4 rounded-radius-xl font-black text-xs uppercase tracking-[0.1em] shadow-elev-modal transition-all active:scale-95 ${currentInvocationsCount >= maxInvocations ? 'bg-slate-200 dark:bg-white/5 text-slate-400 cursor-not-allowed' : 'bg-fuchsia-600 text-white shadow-fuchsia-500/30'}`}>Learn New Invocation</button>
                    </div>
                </div>,
                document.body
            )}
                ...
                <div className="fixed inset-0 z-[70] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="flex flex-col border-b border-slate-200 dark:border-white/10 bg-white dark:bg-surface-dark">
                        <div className="flex items-center gap-4 p-4">
                            <button onClick={() => setShowInvocationsModal(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill hover:bg-black/5 transition-colors"><span className="material-symbols-outlined">arrow_back</span></button>
                            <div className="flex-1 relative">
                                <input type="text" placeholder="Search invocation..." value={invocationSearch} onChange={(e) => setInvocationSearch(e.target.value)} autoFocus className="w-full bg-slate-100 dark:bg-black/20 border border-slate-200 rounded-radius-lg py-2 pl-10 pr-4 text-slate-900 dark:text-white outline-none focus:border-fuchsia-500/50" />
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3 pb-[env(safe-area-inset-bottom)]">
                        {ELDRITCH_INVOCATIONS
                            ...
                            .map(inv => (
                                <button key={inv.name} onClick={() => { toggleInvocation(inv.name); if(inv.name !== 'Lessons of the First Ones') setShowInvocationsModal(false); }} className="w-full text-left p-4 rounded-radius-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/5 hover:border-fuchsia-500/40 transition-all group">
                                    <div className="flex justify-between items-start mb-1">
                                        <span className="font-bold text-base text-slate-900 dark:text-white group-hover:text-fuchsia-500">{inv.name}</span>
                                        {inv.level && <span className="text-[10px] font-black text-fuchsia-500 bg-fuchsia-500/10 px-1.5 py-0.5 rounded-radius-sm">Lvl {inv.level}</span>}
                                    </div>
            ...
            {showOriginFeatSelector && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowOriginFeatSelector(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2">
                        {FEAT_OPTIONS.filter(f => f.description.includes('Origin Feat') && !character.feats?.includes(f.name)).map(feat => (
                            <button key={feat.name} onClick={() => { selectOriginFeatForLessons(feat.name); setShowOriginFeatSelector(false); setShowInvocationsModal(false); }} className="w-full text-left p-4 rounded-radius-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/5 hover:border-emerald-500/40 transition-all group">
            ...
            {showTomeConfig && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowTomeConfig(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                {Object.keys(CANTRIPS).map(name => {
                                    ...
                                    return (
                                        <button key={name} onClick={() => isSelected ? setTempPactCantrips(prev => prev.filter(n => n !== name)) : canAdd && setTempPactCantrips(prev => [...prev, name])} className={`text-left p-3 rounded-radius-lg border transition-all ${isSelected ? 'bg-primary/5 border-primary shadow-sm' : 'bg-white dark:bg-surface-dark border-slate-200 dark:border-white/5 opacity-80'}`}>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                {Object.keys(LEVEL1).filter(name => LEVEL1[name].description.includes('Ritual')).map(name => {
                                    ...
                                    return (
                                        <button key={name} onClick={() => isSelected ? setTempPactRituals(prev => prev.filter(n => n !== name)) : canAdd && setTempPactRituals(prev => [...prev, name])} className={`text-left p-3 rounded-radius-lg border transition-all ${isSelected ? 'bg-primary/5 border-primary shadow-sm' : 'bg-white dark:bg-surface-dark border-slate-200 dark:border-white/5 opacity-80'}`}>
                                            <div className="flex justify-between items-center"><span className={`text-sm font-bold ${isSelected ? 'text-primary' : 'text-slate-700 dark:text-slate-300'}`}>{name}</span>{isSelected && <span className="material-symbols-outlined text-primary text-base">check_circle</span>}</div>
                                        </button>
                                    );
                                })}
                    ...
                    <div className="p-4 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-t border-black/5 dark:border-white/5">
                        <button onClick={() => { onUpdate({ ...character, pactCantrips: tempPactCantrips, pactRituals: tempPactRituals }); setShowTomeConfig(false); }} className="w-full py-4 rounded-radius-xl bg-primary text-background-dark font-black text-xs uppercase tracking-widest shadow-elev-modal shadow-primary/20">Seal Pact</button>
                    </div>
                </div>,
                document.body
            )}
            ...
            {showAgonizingConfig && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowAgonizingConfig(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                        <h3 className="text-sm font-black uppercase tracking-widest text-amber-500">Agonizing Blast</h3>
                        <div className="w-10"></div>
                    </div>
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        <p className="text-xs text-slate-500 dark:text-slate-400 bg-amber-500/5 p-4 rounded-radius-xl border border-amber-500/10 italic text-center">Choose the cantrips that will add your Charisma modifier to damage.</p>
                        <div className="grid grid-cols-1 gap-2">
                            {character.preparedSpells?.filter(s => SPELL_DETAILS[s]?.level === 0 && (SPELL_DETAILS[s]?.description.includes('ranged spell attack') || SPELL_DETAILS[s]?.description.includes('melee spell attack') || s === 'Eldritch Blast')).map(name => {
                                ...
                                return (
                                    <button key={name} onClick={() => isSelected ? setTempAgonizingCantrips(prev => prev.filter(n => n !== name)) : setTempAgonizingCantrips(prev => [...prev, name])} className={`text-left p-4 rounded-radius-xl border transition-all ${isSelected ? 'bg-amber-500/10 border-amber-500 shadow-sm' : 'bg-white dark:bg-surface-dark border-slate-200 dark:border-white/5'}`}>
                    ...
                    <div className="p-4 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-t border-black/5 dark:border-white/5">
                        <button onClick={() => { onUpdate({ ...character, agonizingBlastCantrips: tempAgonizingCantrips }); setShowAgonizingConfig(false); }} className="w-full py-4 rounded-radius-xl bg-amber-500 text-white font-black text-xs uppercase tracking-widest shadow-elev-modal shadow-amber-500/20">Save Selection</button>
                    </div>
                </div>,
                document.body
            )}
            ...
            {showLessonsConfig && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowLessonsConfig(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2">
                        {FEAT_OPTIONS.filter(f => f.description.includes('Origin Feat') && !character.feats?.includes(f.name)).map(feat => (
                            ...
                            }} className="w-full text-left p-4 rounded-radius-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/5 hover:border-emerald-500/40 transition-all group">
                                <span className="block font-bold text-base text-slate-900 dark:text-white group-hover:text-emerald-500 mb-1">{feat.name}</span>
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed">{feat.description}</p>
                            </button>
                        ))}
            ...
            {showWarBondConfig && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowWarBondConfig(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                        <h3 className="text-sm font-black uppercase tracking-widest text-cyan-500">War Bond</h3>
                        <div className="w-10"></div>
                    </div>
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-radius-xl p-4">
                        ...
                        <div className="flex items-center justify-between bg-surface-light dark:bg-surface-dark p-3 rounded-radius-lg">
                        ...
                        <div className="space-y-2">
                            {tempBondedWeapons.length < 2 && (
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 rounded-radius-lg bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/10 text-sm text-slate-900 dark:text-white placeholder:text-slate-400"
                                        onKeyDown={(e) => {
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-3 rounded-radius-lg bg-cyan-600 text-white font-bold text-sm active:scale-95 transition-all"
                                    >
                                        Add
                                    </button>
                                </div>
                            ...
                            {tempBondedWeapons.map((weapon, idx) => (
                                <div key={idx} className="flex items-center gap-3 p-4 rounded-radius-xl bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/5">
                        ...
                        {tempBondedWeapons.length > 0 && character.summonedWeapon === null && (
                            <div className="p-4 rounded-radius-xl bg-cyan-500/10 border border-cyan-500/20">
                                ...
                                <div className="flex gap-2">
                                    {tempBondedWeapons.map((weapon, idx) => (
                                        ...
                                        }} className="flex-1 py-3 rounded-radius-lg bg-cyan-600 text-white font-bold text-sm active:scale-95 transition-all">
                                            Summon {weapon}
                                        </button>
                                    ))}
                                </div>
                    ...
                    <div className="p-4 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-t border-black/5 dark:border-white/5">
                        <button onClick={() => { onUpdate({ ...character, bondedWeapons: tempBondedWeapons }); setShowWarBondConfig(false); }} className="w-full py-4 rounded-radius-xl bg-cyan-500 text-white font-black text-xs uppercase tracking-widest shadow-elev-modal shadow-cyan-500/20">Save Bonded Weapons</button>
                    </div>
                </div>,
                document.body
            )}
            ...
            {showWarMagicModal && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[max(0.75rem,env(safe-area-inset-top))] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowWarMagicModal(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                        <h3 className="text-sm font-black uppercase tracking-widest text-purple-500">War Magic</h3>
                        <div className="w-10"></div>
                    </div>
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        <div className="bg-purple-500/10 border border-purple-500/20 rounded-radius-xl p-4">
                            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            {character.preparedSpells?.filter(s => {
                                ...
                                return (
                                    <button key={cantrip} onClick={() => onUpdate({ ...character, warMagicCantrip: cantrip })} className={`text-left p-4 rounded-radius-xl border transition-all ${isSelected ? 'bg-purple-500/10 border-purple-500 shadow-sm' : 'bg-white dark:bg-surface-dark border-slate-200 dark:border-white/5'}`}>
                    ...
                    <div className="p-4 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-t border-black/5 dark:border-white/5 flex gap-3">
                        <button onClick={() => { onUpdate({ ...character, warMagicCantrip: undefined, warMagicActive: false }); setShowWarMagicModal(false); }} className="flex-1 py-4 rounded-radius-xl bg-slate-200 dark:bg-white/10 text-slate-600 dark:text-slate-400 font-bold text-xs uppercase tracking-widest">Clear</button>
                        <button onClick={() => setShowWarMagicModal(false)} className="flex-1 py-4 rounded-radius-xl bg-purple-500 text-white font-black text-xs uppercase tracking-widest shadow-elev-modal shadow-purple-500/20">Done</button>
                    </div>
                </div>,
                document.body
            )}
            ...
            {showImprovedWarMagicModal && createPortal(
                <div className="fixed inset-0 z-[80] bg-background-light dark:bg-background-dark flex flex-col pt-[env(safe-area-inset-top)] animate-fadeIn">
                    <div className="p-4 border-b border-black/5 dark:border-white/10 bg-white dark:bg-surface-dark flex items-center justify-between">
                        <button onClick={() => setShowImprovedWarMagicModal(false)} className="w-10 h-10 flex items-center justify-center rounded-radius-pill bg-slate-100 dark:bg-white/5 text-slate-500"><span className="material-symbols-outlined">close</span></button>
                        <h3 className="text-sm font-black uppercase tracking-widest text-rose-500">Improved War Magic</h3>
                        <div className="w-10"></div>
                    </div>
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        <div className="bg-rose-500/10 border border-rose-500/20 rounded-radius-xl p-4">
                            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className={`w-12 h-7 rounded-radius-pill transition-all ${character.improvedWarMagicActive ? 'bg-rose-500' : 'bg-slate-300 dark:bg-white/20'}`}
                            >
                                <div className={`w-5 h-5 rounded-radius-pill bg-white shadow-md transition-transform ${character.improvedWarMagicActive ? 'translate-x-6' : 'translate-x-1'}`}></div>
                            </button>
                        </div>
                    </div>
                    <div className="p-4 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md border-t border-black/5 dark:border-white/5">
                        <button onClick={() => setShowImprovedWarMagicModal(false)} className="w-full py-4 rounded-radius-xl bg-rose-500 text-white font-black text-xs uppercase tracking-widest shadow-elev-modal shadow-rose-500/20">Done</button>
                    </div>
                </div>,
                document.body
            )}
