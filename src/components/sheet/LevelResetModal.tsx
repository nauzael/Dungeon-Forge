    ...
    <div className="fixed inset-0 z-[110] bg-slate-900/80 dark:bg-black/60 flex items-end sm:items-center justify-center animate-fadeIn backdrop-blur-sm">
      <div className="w-full sm:max-w-lg bg-white dark:bg-[#0f1525] rounded-t-3xl sm:rounded-radius-2xl shadow-2xl max-h-[95vh] sm:max-h-[85vh] flex flex-col animate-slideUp overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-4">
          <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-radius-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-center justify-between gap-2 text-blue-700 dark:text-blue-300 text-sm">
                ...
                {onForceSync && (
                    <button 
                        onClick={onForceSync}
                        disabled={isSyncing}
                        className="flex items-center gap-1 px-2 py-1 bg-blue-500/10 hover:bg-blue-500/20 rounded-radius-md text-xs font-bold transition-all disabled:opacity-50"
                    >
          ...
          <div className="mb-4 text-[10px] text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-white/5 p-2 rounded-radius-md border border-slate-200 dark:border-white/10 italic">
            <p>Restore points sync with your account so you can recover them on any device.</p>
          </div>
                ...
                {levelUpSnapshots.map((snapshot, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-3 rounded-radius-lg border-2 transition-all text-left ${
                        isSelected
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-6 h-6 rounded-radius-pill border-2 flex items-center justify-center ${
                              isSelected
                          ...
                          <div>
                            ...
                            {isCurrent && (
                              <span className="ml-2 text-[10px] px-1.5 py-0.5 bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300 rounded-radius-sm font-medium">
                                Previous
                              </span>
                            )}
                          </div>
          ...
          {selectedChanges && (
            <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-radius-lg border border-amber-200 dark:border-amber-800">
        ...
        <div className="p-4 border-t border-slate-100 dark:border-white/10 bg-white dark:bg-[#0f1525]">
          {showRestoreConfirm ? (
            <div className="space-y-3">
              <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-radius-lg border border-red-200 dark:border-red-800">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="py-3 rounded-radius-lg font-bold text-sm bg-slate-100 dark:bg-white/10 text-slate-700 dark:text-white hover:bg-slate-200 dark:hover:bg-white/20 transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={handleRestoreConfirm}
                  className="py-3 rounded-radius-lg font-bold text-sm text-white bg-red-500 hover:bg-red-600 transition-colors"
                >
                  Confirm Reset
                </button>
              </div>
            ...
            <div className="space-y-3">
              <div className="p-3 bg-slate-100 dark:bg-white/5 rounded-radius-lg">
            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full py-3 rounded-radius-lg font-bold text-sm text-white shadow-elev-modal transition-all active:scale-[0.98] ${
                  selectedSnapshotId
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={onClose}
                  className="py-2.5 rounded-radius-lg font-bold text-sm bg-slate-100 dark:bg-white/10 text-slate-700 dark:text-white hover:bg-slate-200 dark:hover:bg-white/20 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={!selectedSnapshotId}
                  className={`py-2.5 rounded-radius-lg font-bold text-sm transition-colors ${
                    selectedSnapshotId
