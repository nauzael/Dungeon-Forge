  ...
  return (
    <div className="flex flex-col h-full p-5">
      <div className="text-center mb-5">
        <div className="w-16 h-16 rounded-radius-xl flex items-center justify-center mx-auto mb-3 shadow-elev-modal" style={{backgroundColor: 'var(--color-background-secondary)', color: 'var(--color-text-secondary)', borderWidth: '2px', borderColor: 'var(--color-border)'}}>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar space-y-4">
        {isRanger && (
          <div className="mb-4 p-3 rounded-radius-lg bg-green-500/10 border border-green-500/20">
        ...
        <div className="space-y-2">
          {fightingStyleFeats.map((feat) => (
            <button
              ...
              className={`w-full p-4 rounded-radius-lg border-2 text-left transition-all`}
        ...
        {showCantripPicker && (
          <div className="mt-4 p-4 rounded-radius-lg bg-green-500/10 border border-green-500/20">
              ...
              {DRUID_CANTRIPS.map((cantrip) => {
                ...
                return (
                  <button
                    ...
                    disabled={isDisabled}
                    className={`p-3 rounded-radius-lg border-2 text-left transition-all`}
      ...
      {!canProceed() && (
        <div className="mt-4 p-3 rounded-radius-lg bg-amber-500/10 border border-amber-500/20">
