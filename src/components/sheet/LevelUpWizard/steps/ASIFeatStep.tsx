    ...
    return (
        <div className="flex flex-col h-full p-5">
            <div className="text-center mb-5">
                <div className="w-16 h-16 rounded-radius-xl bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/40 dark:to-orange-900/40 text-amber-600 dark:text-amber-400 flex items-center justify-center mx-auto mb-3 border-2 border-white dark:border-white/20 shadow-elev-modal">
            ...
            <div className="flex gap-3 mb-5">
                <button
                    ...
                    className={`flex-1 py-3.5 rounded-radius-lg font-bold text-sm transition-all`}
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar">
                {asiType === 'stat' ? (
                    <div className="space-y-4">
                        <div className="rounded-radius-lg p-4 text-center" style={{backgroundColor: 'var(--color-background-secondary)'}}>
                                ...
                                {stats.map((stat) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`p-4 rounded-radius-lg border-2 transition-all`}
                    ...
                    <>
                                            ...
                                            {feats.map((f) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`w-full p-4 rounded-radius-lg border-2 text-left transition-all hover:shadow-md ${
                                                            isSelected
                        ...
                        {expandedFeatModal && createPortal(
                            ...
                            >
                                <div
                                    className="w-full sm:max-w-md bg-white dark:bg-[#0f1525] rounded-t-3xl sm:rounded-radius-xl shadow-2xl max-h-[85vh] flex flex-col animate-slideUp overflow-hidden"
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-white/10 shrink-0">
                                        ...
                                        <button
                                            onClick={() => setExpandedFeatModal(null)}
                                            className="w-10 h-10 rounded-radius-md flex items-center justify-center transition-colors"
                                    ...
                                    <div className="flex-1 overflow-y-auto px-5 py-4">
                                        ...
                                        {expandedFeatModal.asi && (
                                            <div className="mb-4 inline-block px-3 py-1.5 rounded-radius-pill bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 text-sm font-bold">
                                        ...
                                        {expandedFeatModal.prerequisite && (
                                            <div className="mb-4 p-3 rounded-radius-md bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                                    ...
                                    <div className="border-t border-slate-100 dark:border-white/10 px-5 py-4 shrink-0 space-y-3 bg-slate-50 dark:bg-white/5">
                                        ...
                                        {feat === expandedFeatModal.name && expandedFeatModal.asi && expandedFeatModal.asi.length > 0 && (
                                            <div className="p-3 rounded-radius-md bg-amber-50 dark:bg-amber-900/20 border border-amber-500/30">
                                                    ...
                                                    {expandedFeatModal.asi.map((stat) => {
                                                        ...
                                                        return (
                                                            <button
                                                                ...
                                                                className={`p-2.5 rounded-radius-md border-2 transition-all ${
                                                                    isStatSelected
                                        ...
                                        {feat !== expandedFeatModal.name ? (
                                            <button
                                                ...
                                                className="w-full py-3 rounded-radius-md font-bold text-white bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 transition-all shadow-elev-modal active:scale-[0.98]"
                                            >
                                                Select Feat
                                            </button>
                                        ) : (
                                            <button
                                                onClick={() => setExpandedFeatModal(null)}
                                                className="w-full py-3 rounded-radius-md font-bold text-white bg-emerald-500 hover:bg-emerald-600 transition-all shadow-elev-modal active:scale-[0.98]"
                                            >
                                                ✓ Feat Selected
                                            </button>
                                        )}
