    ...
    return (
        <div className="flex flex-col h-full p-4">
            ...
            <div className="text-center mb-4">
                <div className="w-14 h-14 rounded-radius-pill flex items-center justify-center mx-auto mb-2 border-4 border-white dark:border-surface-dark shadow-elev-modal bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">
            ...
            <div className="grid grid-cols-3 gap-2 mb-4 text-center text-xs">
                <div className="bg-gray-800 rounded-radius-sm p-2">
                ...
                <>
                    ...
                    <div className="mb-4 space-y-2">
                        <input
                            ...
                            className="w-full px-3 py-2 bg-gray-700 text-white text-sm rounded-radius-sm border border-gray-600 focus:outline-none focus:border-blue-500"
                        />
                    ...
                    {/* Spell List */}
                    <div className="flex-1 overflow-y-auto border border-gray-700 rounded-radius-sm bg-gray-900">
