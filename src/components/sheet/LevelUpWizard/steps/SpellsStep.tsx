    ...
    return (
        <div className="flex flex-col h-full p-4">
            <div className="text-center mb-4">
                <div className={`w-14 h-14 rounded-radius-pill flex items-center justify-center mx-auto mb-2 border-4 border-white dark:border-surface-dark shadow-elev-modal ${
                    needsMetamagic 
            ...
            <div className="flex-1 overflow-y-auto">
                {needsMetamagic ? (
                        ...
                        {METAMAGIC_OPTIONS.map(m => {
                            ...
                            return (
                                <button
                                    ...
                                    disabled={isDisabled}
                                    className={`w-full p-4 rounded-radius-lg border text-left transition-all ${
                                        isSelected 
                    ...
                    <div className="text-center py-6">
                        <div className="w-16 h-16 rounded-radius-pill bg-blue-100 dark:bg-blue-900/20 mx-auto mb-4 flex items-center justify-center">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/10 rounded-radius-lg p-4 border border-blue-100 dark:border-blue-800/30">
                    ...
                    <div className="text-center py-6">
                        <div className="w-16 h-16 rounded-radius-pill bg-slate-100 dark:bg-slate-800/50 mx-auto mb-4 flex items-center justify-center">
            ...
            {needsMetamagic && selectedMetamagics.length > 0 && (
                <div className="mt-4 p-3 bg-purple-500/10 rounded-radius-lg border border-purple-500/20">
