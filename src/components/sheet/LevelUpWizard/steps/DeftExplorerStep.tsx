    ...
    return (
        <div className="flex flex-col h-full p-4 overflow-y-auto no-scrollbar">
            ...
            <div className="text-center mb-6">
                <div className="w-14 h-14 rounded-radius-lg bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/40 dark:to-indigo-900/40 text-purple-600 dark:text-purple-400 flex items-center justify-center mx-auto mb-2 border border-white dark:border-white/20 shadow-sm">
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    {notYetExpert.length === 0 ? (
                        <div className="bg-amber-50 dark:bg-amber-900/20 rounded-radius-md p-3 text-xs text-amber-700 dark:text-amber-300">
                        ...
                        <div className="space-y-2 max-h-32 overflow-y-auto">
                            {notYetExpert.map((skill) => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2.5 rounded-radius-md border-2 transition-all ${
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 max-h-48 overflow-y-auto">
                        {availableLanguages.map((language) => (
                            <button
                                ...
                                className={`px-3 py-2 rounded-radius-md border-2 transition-all text-xs font-medium ${
                    ...
                    {selectedLanguages.length === 2 && (
                        <div className="bg-green-50 dark:bg-green-900/20 rounded-radius-md p-3 text-xs text-green-700 dark:text-green-300">
