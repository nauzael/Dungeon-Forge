    ...
    return (
        <div className="flex flex-col h-full p-4 overflow-y-auto no-scrollbar">
            <div className="text-center mb-4">
                <div className="w-14 h-14 rounded-radius-lg bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/40 dark:to-emerald-900/40 text-green-600 dark:text-green-400 flex items-center justify-center mx-auto mb-2 border border-white dark:border-white/20 shadow-sm">
            ...
            <div className="space-y-3">
                <div className="bg-slate-50 dark:bg-white/5 rounded-radius-lg border border-slate-200 dark:border-white/10 overflow-hidden">
                    <button
                    ...
                    >
                        <div className="flex items-center gap-3">
                            <div className={`w-9 h-9 rounded-radius-md flex items-center justify-center ${
                                hpMethod === 'average'
                        ...
                        <div className="mt-2 pl-12 text-xs text-slate-600 dark:text-slate-300">
                            <span className="font-mono bg-slate-200 dark:bg-white/10 px-1.5 py-0.5 rounded-radius-sm">
                            ...
                            <div className="mt-3 space-y-2">
                                <div className="flex items-center justify-center gap-3">
                                    <button
                                        ...
                                        className="w-8 h-8 rounded-radius-md bg-slate-200 dark:bg-white/10 flex items-center justify-center hover:bg-slate-300"
                                    >
                                    ...
                                    <input
                                        ...
                                        className="w-14 h-10 text-center border rounded-radius-md font-mono text-lg font-bold outline-none focus:border-purple-500" 
                ...
                <div className="bg-slate-50 dark:bg-white/5 rounded-radius-lg border border-slate-200 dark:border-white/10 p-4 space-y-3">
                    <div className="space-y-2">
                        ...
                        {/* Base components */}
                        <div className="bg-white dark:bg-white/5 rounded-radius-md p-2.5 space-y-2">
                            <div className="flex justify-between items-center text-xs">
                                <span className="text-slate-600 dark:text-slate-300">Base Gain (Hit Die)</span>
                                <span className="font-mono bg-slate-100 dark:bg-white/10 px-2 py-1 rounded-radius-sm text-slate-900 dark:text-white font-bold">
                                    {avgRoll}
                                </span>
                            </div>
                            <div className="flex justify-between items-center text-xs">
                        ...
                        {activeBonuses.filter(b => b.type === 'per-level').length > 0 && (
                            <div className="bg-green-50 dark:bg-green-900/20 rounded-radius-md p-2.5 space-y-1.5">
                                ...
                                {activeBonuses.filter(b => b.type === 'per-level').map((bonus, idx) => (
                                    <div key={idx} className="flex justify-between items-center text-xs">
                                        ...
                                        <span className="font-mono bg-green-100 dark:bg-green-900/40 px-2 py-1 rounded-radius-sm text-green-700 dark:text-green-300 font-bold">
                                            +{bonus.value}
                                        </span>
                                    </div>
                                ))}
                        ...
                        {activeBonuses.filter(b => b.type === 'one-time').length > 0 && (
                            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-radius-md p-2.5 space-y-1.5">
                                ...
                                {activeBonuses.filter(b => b.type === 'one-time').map((bonus, idx) => (
                                    <div key={idx} className="flex justify-between items-center text-xs">
                                        ...
                                        <span className="font-mono bg-amber-100 dark:bg-amber-900/40 px-2 py-1 rounded-radius-sm text-amber-700 dark:text-amber-300 font-bold">
                                            +{bonus.value}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-radius-md p-2.5 border border-blue-200 dark:border-blue-800">
                            <div className="flex justify-between items-center text-xs mb-1">
                                <span className="text-slate-600 dark:text-slate-300 font-medium">
                                    Subtotal This Level
                                </span>
                                <span className="font-mono bg-blue-100 dark:bg-blue-900/40 px-2 py-1 rounded-radius-sm text-blue-700 dark:text-blue-300 font-bold">
                                    {calculatedGain}
                                </span>
                            </div>
                ...
                <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 dark:from-green-500/20 dark:to-emerald-500/20 rounded-radius-lg border border-green-500/30 p-3 text-center">
