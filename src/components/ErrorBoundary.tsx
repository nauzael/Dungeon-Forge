    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#0F172A] text-white p-6 text-center font-display">
          <div className="bg-red-500/10 p-5 rounded-radius-pill mb-6 ring-1 ring-red-500/30">
          ...
          {error && (
            <div className="w-full max-w-lg bg-black/30 rounded-radius-lg p-4 mb-8 text-left border border-white/5">
              ...
              <div className="bg-black/50 rounded-radius-md p-3">
                ...
                <div className="mt-4 space-y-4">
                  {stackLines.length > 0 && (
                    <div>
                      ...
                      <pre className="text-[10px] font-mono text-slate-400 bg-black/50 rounded-radius-md p-3 overflow-x-auto max-h-48 whitespace-pre-wrap">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                      {errorLogs.map((log, i) => (
                        <div key={i} className="text-[10px] font-mono bg-black/30 rounded-radius-sm p-2 border border-white/5">
          ...
          <button
            ...
            className="w-full max-w-xs py-4 bg-[#359EFF] hover:bg-[#2B7DE0] text-[#0F172A] rounded-radius-lg font-bold text-lg shadow-elev-modal shadow-blue-500/20 transition-all active:scale-[0.98]"
          >
            Restart Application
          </button>
        </div>
